...
export default function Reflection() {
  ...
  const reflections = [
    ...
    {
    title: "Kisan Bandhu – Empowering Farmers",
    content: `Kisan Bandhu was built after hearing repeated suggestions from people in my village. They wanted a simple mobile app to help with plant disease diagnosis, mandi prices, weather forecasts, and schemes. Kisan Bandhu supports 11 Indian Languages . Seeing it actually help farmers around me made the experience incredibly meaningful.<br/><a href="https://blogwave.yuvrajyadav.tech/blog/681ad0827f3b1c5a03935ebe" target="_blank" class="text-blue-400 underline">read more</a>`,
  },
  {
    ...
    },
    {
     ...
     {
    title: "LinkUp – The Professional Network",
    content: `With LinkUp, I aimed to create a professional networking platform tailored for developers and professionals to share posts, make connections, and discover job opportunities. Implementing real-time chat using Socket.io and building features like customizable profiles and smart notifications gave me a deep understanding of full-stack architecture and real-time systems.<br/><a href="https://blogwave.yuvrajyadav.tech/blog/6821a3e837f5542208f0529b" target="_blank" class="text-blue-400 underline">read more</a>`,
  },
    {
  ...
  useEffect(() => {
    if (selectedReflection && detailsRef.current) {
    ...
    <section id="reflections" className="bg-gray-900 pt-20 pb-10">
      <div className="container mx-auto px-4">
        ...
        <div className="reflection-container">
          <div className="reflection-left">
            {displayedReflections.map((reflection, index) => (
              <ReflectionCard
                ...
                onReadLess={() => setSelectedReflection(null)}
              />
            ))}
          ...
          <div className="reflection-right" ref={detailsRef}>
            {selectedReflection ? (
              <div className="bg-gray-800 p-6 shadow-lg text-white right-text">
                ...
                <p
                  className={`text-gray-400 mb-6 des`}
