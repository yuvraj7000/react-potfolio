...
const ContactSection = () => {
  return (
    <section id="contact" className="bg-gray-900 py-20  text-white">
      <div className="container mx-auto px-4">
        <h3 className="text-4xl font-bold mb-10 text-center">Contact Me</h3>
        <p className="text-center text-lg mb-5">
          I am always open to discussing new projects, creative ideas, or
          opportunities to be part of your vision. Feel free to reach out!
        </p>
        <form className="w-full max-w-lg mx-auto mb-5">
          <div className="mb-3">
            <input
              type="text"
              placeholder="Your Name"
        ...
        <div className="flex justify-center items-center space-x-8">
          <a
            href="https://github.com/YuvrajYadav700"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/yuvraj-yadav700"
            target="_blank"
            rel="noopener noreferrer"
            className="text-3xl hover:text-yellow-400 transition duration-300"
          >
