...
const ReflectionCard = ({ title, content, onReadMore, onReadLess }) => {
  ...
  return (
    <div className="bg-gray-800 text-white  shadow-lg transform hover:scale-105 transition duration-300 ease-in-out my-2 ref-con">
      ...
      <p className={`text-gray-400 mb-3 ref-des des`}>
        {content}
      </p>
      <button
        onClick={toggleExpansion}
        className="bg-blue-800 text-white px-4 py-1 rounded hover:bg-blue-600 transition duration-200 focus:outline-none ref-btn"
      >
